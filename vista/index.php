...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>SPASSSIO</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <a onclick="cargar_contenido('contenido_principal','categoria/vista_categoria_listar.php')">
            <i class="fa fa-cubes"></i> <span>Grupo de trabajo</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <a onclick="cargar_contenido('contenido_principal','clasificacion/vista_clasificacion_listar.php')">
            <i class="fa fa-list"></i> <span>Clasificacion</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <a onclick="cargar_contenido('contenido_principal','rutina/vista_rutina_listar.php')">
            <i class="fa fa-heartbeat"></i> <span>Rutinas</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <a onclick="cargar_contenido('contenido_principal','dietas/vista_diestas_listar.php')">
            <i class="fa fa-cutlery"></i> <span>Orientación Nutricional</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <!-- <a onclick="cargar_contenido('contenido_principal','bitacoras/vista_clasificacion_listar.php')">
            <i class="fa fa-file-text-o"></i> <span>Bitacoras</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <a onclick="cargar_contenido('contenido_principal','cuestionario/vista_clasificacion_listar.php')">
            <i class="fa fa-list-ol"></i> <span>Cuestionario de salud</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a> -->
    ...
    <div class="row" id="contenido_principal">
        <div class="col-md-12">
          <div class="box box-warning box-solid">
            ...
            <div>
                <center>
                  <img src="../img/meditacion.jpg" width="450" ></img>
                </center>
            </div>
            <!-- /.box-body -->
          </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="index.php">SPASSSIO</a>.</strong> All rights
    reserved.
  </footer>
